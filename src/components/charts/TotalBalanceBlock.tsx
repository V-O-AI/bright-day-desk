      ...
      <div className={cn("bg-card rounded-2xl border border-border h-full flex flex-col justify-between", compact ? "p-4 gap-2" : "p-6")}>
        ...
        <div className={cn("flex justify-center", compact ? "mt-2" : "mt-6")}>
          <div
            ...
            className={cn(
              "group relative bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-3 border border-primary/20 cursor-pointer hover:border-primary/40 hover:shadow-md hover:shadow-primary/10 hover:-translate-y-0.5 transition-all duration-200 text-center",
              compact ? "w-1/3" : "w-2/5"
            )}
          >
            ...
            <div className="flex items-center justify-center gap-1.5 relative z-10">
              <p className={cn("font-bold text-foreground", compact ? "text-xs" : "text-sm")}>{roiPercent.toFixed(1)}%</p>
