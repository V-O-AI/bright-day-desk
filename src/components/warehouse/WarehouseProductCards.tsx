...
export function WarehouseProductCards() {
  ...
  return (
    <div className="border border-border rounded-2xl p-5 h-full flex flex-col px-[2px] bg-primary-foreground">
      <div className="gap-2 mb-3 flex items-start justify-center border-solid">
        {selectedCategory &&
        <button
      ...
      <div className="relative flex-1 min-h-0 px-0 my-[50px]">
        <button
          onClick={scrollLeft}
